...
fs+l5UvWsNfbeltv6+3a7f8FGACfR68dOgDApwAAAABJRU5ErkJggg=="
    ...
    <svg
      :style="style"
      v-if="this.iconName == 'webscraping'"
    ...
    <svg :style="style" viewBox="0 0 128 128" v-if="this.iconName == 'react'">
      <path
    ...
    <svg
      :style="style"
      viewBox="20 25 150 150"
      style=" fill:#000000;"
      v-if="this.iconName == 'p5'"
    >
    ...
    >
      <g id="surface1">
        ...
        <path
          style=" fill:#1976D2;"
          d="M 7.398438 16.800781 L 12 24 L 14.398438 20.300781 L 8.5 15 Z "
        />
        <path
          style=" fill:#F9A825;"
          d="M 24.601563 42 L 29.699219 34 L 24.898438 34 L 22.601563 42 Z "
        />
        <path
          style=" fill:#DD2C00;"
        ...
        <path
          style=" fill:#BF360C;"
          d="M 38.898438 14 L 29.699219 14 L 32.199219 17.898438 L 40.101563 16 Z "
        />
      </g>
    </svg>
...
export default {
  ...
  computed: {
    style() {
      return `fill: ${this.iconColor}; width: ${this.iconSize};`;
    }
  }
};
</script>
